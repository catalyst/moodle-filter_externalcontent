...
$string['settings:textcolour_desc'] = 'The text colour of the label prepended before matching links.';
$string['settings:textcolour_help'] = 'The text colour of the label prepended before matching links. Enter a hex ' .
